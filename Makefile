...
MEMCPY_CFLAGS = -I../em/wpa_supp_leak/src/ -I../em/wpa_supp_leak/wpa_supplicant -I../em/wpa_supp_leak/src/utils/ -ffunction-sections -fdata-sections -g -mtune=skylake -fno-stack-protector -fno-pie -no-pie -fno-plt -static

all: simulate hmac-sha1 simple memcpy
...
memcpy: memcpy.c
	$(CC) -DCONFIG_CRYPTO_INTERNAL $(MEMCPY_CFLAGS) $(LDFLAGS) $^ -o $@

clean:
	$(RM) simulate hmac-sha1 simple memcpy
